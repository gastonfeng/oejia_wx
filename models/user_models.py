...
class wx_corpuser(models.Model):
    ...
    name = fields.Char(u'昵称', required=True)
    userid = fields.Char(u'账号', required=True)
    avatar = fields.Char(u'头像', )
    position = fields.Char(u'职位', )
    gender = fields.Selection([(1, u'男'), (2, '女')], string=u'性别', )
    weixinid = fields.Char(u'微信号', )
    mobile = fields.Char(u'手机号', )
    email = fields.Char(u'邮箱', )
    status = fields.Selection([(1, u'已关注'), (2, u'已禁用'), (4, u'未关注')], string=u'状态', default=4)
